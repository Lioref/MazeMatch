 ...
 * runs an adapted BFS algorithm to find the shortest path to an unvisited cell, and proceeds in that direction */

using namespace std;

class VectorShortestPathHybrid : public AbstractAlgorithm {
private:
...
public:
    ...
    VectorShortestPathHybrid::Move getFirstMoveFromPathsMap(map<tuple<int, int>, tuple<Move, tuple<int, int>>> &pathsMap,
